...
describe("room list", () => {
  ...
  it("dismisses the latest-message toast when the transcript end becomes visible", async () => {
    ...
    const onIntersect = callbacks.at(-1);
    if (!onIntersect) throw new Error("expected a transcript-end observer");
