...
Generate 5 or 6 distinct, natural questions. Each word must be the preferred answer in at least one question. Do not generate question IDs; the server assigns stable IDs after validation.
