...
# PARAKEET_SERVER_URLS=parakeet-tdt@http://localhost:8083
```
...
docker run --rm -p 8080:8080 \
  ...
  -e WHISPER_SERVER_URLS=whisper-large-v3-turbo@http://host.docker.internal:8082 \
